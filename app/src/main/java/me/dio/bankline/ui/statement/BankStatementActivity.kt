...
class BankStatementActivity : AppCompatActivity() {
    ...
    companion object {
        const val EXTRA_ACCOUNT_HOLDER = "ee.dio.bankline.ui.statement.EXTRA_ACCOUNT_HOLDER"
    }
    ...
    private fun findBankStatement(){
        ...
        /*Dados estáticos utilizados para testes:
        ...
        dataSet.add(Movimentacao(1, "03/05/2022 09:24:55", "Lorem Ipsum", 2000.0, TipoMovimentacao.DESPESA, 1))
        dataSet.add(Movimentacao(1, "03/05/2022 09:24:55", "Lorem Ipsum", 3000.0, TipoMovimentacao.RECEITA, 1))
        dataSet.add(Movimentacao(1, "03/05/2022 09:24:55", "Lorem Ipsum", 4000.0, TipoMovimentacao.DESPESA, 1))
        dataSet.add(Movimentacao(1, "03/05/2022 09:24:55", "Lorem Ipsum", 5000.0, TipoMovimentacao.RECEITA, 1))
        binding.rvBankStatement.adapter = BankStatementAdapter(dataSet)
        //Código abaixo utilizado para conexão na api:
        */
